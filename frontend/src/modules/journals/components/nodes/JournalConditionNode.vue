...
// components/journal/nodes/JournalConditionNode.vue
...
<template>
  <div class="wf-node wf-node--condition" :class="{ 'wf-node--selected': selected }">
    ...
    <div class="wf-node__body">
      ...
      <!-- Ветки (выровнены по хэндлам на правом краю) -->
...
/* Хэндлы веток на правом краю, выровнены по бейджам «Да»/«Нет» снизу карточки */
:deep(.wf-handle--true) {
  top: auto !important;
