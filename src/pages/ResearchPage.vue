...
const selectionActions = computed<SelectionAction[]>(() => [
  {
    ...
    color: 'primary',
    disabled: !crudContent.value?.canConfirmSelectedResearch,
    onClick: () => crudContent.value?.confirmSelectedResearch(),
  },
  {
    label: 'В работу',
    icon: 'i-lucide-play',
    color: 'primary',
    disabled: !crudContent.value?.canStartSelectedResearch,
    onClick: () => crudContent.value?.startSelectedResearch(),
  },
  {
    label: 'Отклонить',
    icon: 'i-lucide-ban',
    color: 'error',
    disabled: !crudContent.value?.canRejectSelectedResearch,
    onClick: () => crudContent.value?.rejectSelectedResearch(),
  },
  {
    label: 'Удалить',
    icon: 'i-lucide-trash',
