...
<template>
  <div
    class="inline-flex w-full gap-3 rounded-2xl border border-default/70 bg-default/85 p-2 shadow-lg backdrop-blur"
  >
    <div class="space-y-1 w-full">
      <p
        class="px-1 text-[10px] font-semibold uppercase tracking-[0.18em] text-muted"
      >
        {{ t("userMenu.theme") }}
      </p>
      <UTabs
