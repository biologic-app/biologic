  ...
  ru: {
    ...
    errors: {
      ...
      forbidden: {
        ...
        description: 'У вашей учётной записи сейчас нет прав для просмотра этого раздела или выполнения действия.',
      },
      notFound: {
  ...
  en: {
    ...
    errors: {
      ...
      forbidden: {
        ...
        description: 'Your account currently does not have permission to open this section or perform this action.',
        alertTitle: 'Permission required',
        alertDescription: 'If this page should be available, review the user role or request access from an administrator.'
      },
      notFound: {
        code: '404 Not Found',
        title: 'This page does not exist anymore or was never created.',
        description: 'Check the address, open the needed section from navigation, or return to the main workspace.',
