...
export const agents = {
  ...
  // implement: Smithers would normally suggest Codex here, but Codex is not available: missing `codex` on PATH; missing credentials (~/.codex/auth.json or $OPENAI_API_KEY).
  implement: [
    providers.claudeSonnet,
    providers.claude,
    // providers.codex,
